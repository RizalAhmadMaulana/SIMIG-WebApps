...
const BarangMasuk = () => {
  ...
  return (
    <DashboardLayout>
        <h2 className="text-2xl font-bold text-black mb-6">Kelola Barang / Barang Masuk</h2>
        ...
        <Modal 
            ...
            title={<><Plus className="w-5 h-5" /> Tambah Barang Masuk</>}
            size="max-w-2xl"
        >
        ...
        <Modal 
            ...
            title={<><Edit className="w-5 h-5" /> Edit Barang Masuk</>}
            size="max-w-2xl"
        >
            <div className="space-y-3">
                <FormBarangMasuk />
        ...
        <Modal 
            ...
            title={<><Trash2 className="w-5 h-5" /> Hapus Barang Masuk</>}
            size="max-w-lg"
        >
            <p className="text-gray-700 font-medium py-4">Apakah anda ingin menghapus data barang masuk ini?</p>
